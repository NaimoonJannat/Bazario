...
const saveUserToDB = async (name, email, photoURL) => {
  try {
    ...
    if (!existingUser?.email) {
      ...
      console.log(' New user saved to backend:', result);
    } else {
...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      await saveUserToDB(
        signedInUser.displayName || "No Name",
        signedInUser.email,
  ...
  return (
    <div className='flex justify-center items-center min-h-[calc(100vh-306px)]'>
      <div className='flex w-full max-w-sm  my-20 mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl '>
        <div
