 ...
 const addSelectedToCart = async () => {
  ...
  return (
    <section className="container px-4 mx-auto">
      ...
      {/* Pagination (exactly like before) */}
      ...
      <div className="flex justify-center space-x-4 mt-6">
        <button
          ...
          className="px-6 py-3 border-2 border-[#d4ff00] text-sm font-semibold rounded-lg bg-[#001f3f] text-[#d4ff00] hover:bg-[#d4ff00] hover:text-[#001f3f]"
        >
          Add to Cart
        </button>
